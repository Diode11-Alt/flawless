...
<section class="page-header bg-gradient-minimal" style="padding: 120px 0 80px; text-align: center;">
    <div class="container">
        <h1 style="font-family: var(--font-heading); font-size: 42px; margin-bottom: 15px; color: var(--primary-navy);">Tell Us Your Hiring Requirement
        </h1>
        <p style="font-size: 18px; color: var(--text-muted); max-width: 600px; margin: 0 auto;">Partner with PrimePath to source, vet, and relocate the talent your business needs to grow across the UAE and the GCC region.</p>
    </div>
</section>

<!-- Requirement Form Section -->
<section class="section bg-gradient-minimal" style="padding: 100px 0;">
    <div class="container">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 60px; max-width: 1100px; margin: 0 auto; align-items: start;">
            ...
            <div class="animate-up delay-1">
                ...
                <p style="color: var(--text-muted); font-size: 16px; margin-bottom: 25px; line-height: 1.7;">PrimePath HR is a premier recruitment consultancy sourcing hospitality, retail, and construction talent for employers across the UAE and the broader GCC region. Every candidate is trade-tested and thoroughly vetted before you ever see a profile.</p>
                ...
                <div style="background: white; padding: 25px; border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); display: flex; align-items: center; gap: 20px;">
                    ...
                    <div>
                        ...
                        <a href="tel:+35699000000" style="font-family: var(--font-heading); font-size: 20px; font-weight: 600; color: var(--primary-navy); text-decoration: none;">+356 9900 0000</a>
                    </div>
                </div>
            </div>
                ...
                <form action="requirement.php" method="POST" id="requirementForm">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label class="shadcn-label">Full Name *</label>
                            <input type="text" name="name" required class="shadcn-input">
                        </div>
                        
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label class="shadcn-label">Company Name *</label>
                            <input type="text" name="company" required class="shadcn-input">
                        </div>
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label class="shadcn-label">Email Address *</label>
                            <input type="email" name="email" required class="shadcn-input">
                        </div>
                        
                        <div class="form-group" style="margin-bottom: 20px;">
                            <label class="shadcn-label">Phone Number *</label>
                            <input type="tel" name="phone" required class="shadcn-input">
                        </div>
                    </div>

                    <div class="form-group" style="margin-bottom: 20px;">
                        <label class="shadcn-label">Required Job Titles *</label>
                        <textarea name="job_titles" required rows="3" placeholder="e.g. 5 Masons, 3 Electricians, 10 Retail Associates" class="shadcn-input" style="resize: vertical;"></textarea>
                    </div>

                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="form-group" style="margin-bottom: 25px;">
                            <label class="shadcn-label">Total Vacancies</label>
                            <select name="vacancies" class="shadcn-input">
                        ...
                        <div class="form-group" style="margin-bottom: 25px;">
                            <label class="shadcn-label">Expected Timeline</label>
                            <select name="timeline" class="shadcn-input">
                    ...
                    <button type="submit" class="btn btn-primary border-beam-btn" style="width: 100%; padding: 16px; font-size: 16px; font-weight: 600; border-radius: 12px;">Submit Requirement</button>
                </form>
            </div>
...
<section class="section" style="background: white; padding: 80px 0;">
    <div class="container" style="max-width: 900px; margin: 0 auto; text-align: center;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 30px;">
            <div class="bg-gradient-minimal-card" style="padding: 20px; border-radius: 12px;">
...
<!-- Why Choose Us -->
<section class="section bg-gradient-minimal" style="padding: 80px 0; border-top: 1px solid var(--border-color);">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            <div style="display: flex; gap: 20px; align-items: flex-start; background: white; padding: 25px; border-radius: 16px; box-shadow: var(--shadow-sm);">
                ...
                <div>
                    ...
                    <p style="color: var(--text-muted); font-size: 15px; margin: 0;">All candidates are physically tested and vetted before shortlisting, ensuring immediate productivity.</p>
                </div>
            </div>
            <div style="display: flex; gap: 20px; align-items: flex-start; background: white; padding: 25px; border-radius: 16px; box-shadow: var(--shadow-sm);">
                <div style="min-width: 40px; height: 40px; background: rgba(14, 165, 233, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--secondary-blue); font-size: 18px;"><i class="fas fa-check"></i></div>
                <div>
                    ...
                    <p style="color: var(--text-muted); font-size: 15px; margin: 0;">We manage the entire Work Permit application process locally, removing the administrative burden from your team.</p>
                </div>
            </div>
            <div style="display: flex; gap: 20px; align-items: flex-start; background: white; padding: 25px; border-radius: 16px; box-shadow: var(--shadow-sm);">
                <div style="min-width: 40px; height: 40px; background: rgba(14, 165, 233, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--secondary-blue); font-size: 18px;"><i class="fas fa-check"></i></div>
                <div>
                    ...
                    <p style="color: var(--text-muted); font-size: 15px; margin: 0;">By sourcing through our global networks, we bypass the complexities of unstructured recruitment, significantly reducing deployment times.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section" style="background: white; padding: 80px 0; border-top: 1px solid var(--border-color);">
    <div class="container" style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 25px; padding-bottom: 25px; border-bottom: 1px solid #e2e8f0;">
            <h4 style="font-size: 18px; color: var(--primary-navy); margin-bottom: 10px;">How long does deployment take to the UAE?</h4>
            <p style="color: var(--text-muted); line-height: 1.6; margin: 0;">Once the MOHRE Work Permit is approved, deployment generally takes 15-30 days, including final exit formalities and flights.</p>
        </div>
        
        <div style="margin-bottom: 25px; padding-bottom: 25px; border-bottom: 1px solid #e2e8f0;">
            <h4 style="font-size: 18px; color: var(--primary-navy); margin-bottom: 10px;">Do you guarantee the skills of the candidates?</h4>
            <p style="color: var(--text-muted); line-height: 1.6; margin: 0;">Yes. Our 95%+ success rate is driven by mandatory practical trade testing conducted at our partner facilities before any candidate is presented to you.</p>
        </div>
